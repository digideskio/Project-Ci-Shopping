...
class MY_Email extends CI_Email {
     ...
     function config($data){
        $this->_mail=array(
                            "from_sender"       => "quan.li2609@gmail.com",
                            "name_sender"       => "Nguyen Minh Quan",
                            "subject_sender"    => "Hỗ trợ thành viên",
                         );
     ...
     function sendmail(){
            ...
            $config['smtp_user']    = 'quan.li2609@gmail.com'; // địa chỉ gmail
            $config['smtp_pass']    = 'minhquan'; // pass gmail
