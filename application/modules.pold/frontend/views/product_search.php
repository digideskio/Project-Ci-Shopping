...
<div class="view">
Hiển thị : <a href="?mode=grid&keytype=<?php echo $keytype; ?>&search=<?php echo $product; ?>">Dạng lưới</a> / <a href="?mode=list&keytype=<?php echo $keytype; ?>&search=<?php echo $product; ?>">Dạng danh sách</a> 
</div>
<?php
	switch ($view) {
		case 'list':
