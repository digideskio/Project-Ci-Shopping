    ...
    <style> 
        ...
        .bricon
        {
            background: url(<?php echo base_url(); ?>upload/img/browser-icons.png);
        }
    </style>
    <!-- it works the same with all jquery version from 1.x to 2.x -->
    <script type="text/javascript" src="<?php echo base_url(); ?>public/Libs/slide/js/jquery-1.9.1.min.js"></script>
    <!-- use jssor.slider.mini.js (40KB) or jssor.sliderc.mini.js (32KB, with caption, no slideshow) or jssor.sliders.mini.js (28KB, no caption, no slideshow) instead for release -->
    <!-- jssor.slider.mini.js = jssor.sliderc.mini.js = jssor.sliders.mini.js = (jssor.core.js + jssor.utils.js + jssor.slider.js) -->
    <script type="text/javascript" src="<?php echo base_url(); ?>public/Libs/slide/js/jssor.core.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>public/Libs/slide/js/jssor.utils.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>public/Libs/slide/js/jssor.slider.js"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; width: 980px;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(<?php echo base_url(); ?>upload/img/loading.gif) no-repeat center center;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px; height: 380px;
            overflow: hidden;">
            <div>
                <img u="image" src="<?php echo base_url(); ?>upload/August2014120714PMSamsung-Galaxy-Alpha-den-6-1.jpg" />
            ...
            <div> 
                <img u="image" src="<?php echo base_url(); ?>upload/August2014120706PMSamsung-Galaxy-Alpha-den-1-1.jpg" />
            ...
            <div> 
                <img u="image" src="<?php echo base_url(); ?>upload/August2014120727PMSamsung-Galaxy-Alpha-den-7-1.jpg" />
            ...
            <div>
                <img u="image" src="<?php echo base_url(); ?>upload/September2014054137PMSeptember2014123416PM10644132_840116326013521_8455907564493644837_o.jpg" />
                ...
                <img u="caption" t="T|IB" t2=B d=-900 src="<?php echo base_url(); ?>upload/img/home/moc-iphone.png" style="position:absolute;left:600px;top:230px;width:120px;height:80px;" />
                <img u="caption" t="RTTL|BR" d=-450 src="<?php echo base_url(); ?>upload/img/home/moc-ipad.png" style="position:absolute;left:750px;top:220px;width:77px;height:100px;" />
            </div>
            ...
            <style>
                .share-icon {
                    ...
                    background-image: url(<?php echo base_url(); ?>upload/img/share/share-icons.png);
                }
        ...
        .share-stumbleupon {
            ...
            <img u="any" class="qr_code" src="<?php echo base_url(); ?>upload/img/qr/jssor.com.png" style="position: absolute; width: 80px; height: 80px; bottom: 20px; right: 20px; opacity: .5; filter: alpha(opacity=50);" />
        ...
        <style>
            ...
            */
            ...
            {
                background: url(<?php echo base_url(); ?>upload/img/b03.png) no-repeat;
                overflow:hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora20l, .jssora20r, .jssora20ldn, .jssora20rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(<?php echo base_url(); ?>upload/img/a20.png) no-repeat;
                overflow:hidden;
            }
